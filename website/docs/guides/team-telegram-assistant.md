...
- **Set `GATEWAY_ALLOW_ALL_USERS=false`** on a bot with terminal access — otherwise Hermes defaults to open access and anyone who finds your bot could run commands on your server
