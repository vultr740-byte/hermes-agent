...
sidebar_label: "Guizang Ppt Skill"
description: "Use when creating single-file HTML web PPT decks with horizontal slide navigation, WebGL backgrounds, magazine-style or Swiss-style visual systems, section c..."
---
...
Use when creating single-file HTML web PPT decks with horizontal slide navigation, WebGL backgrounds, magazine-style or Swiss-style visual systems, section covers, data hero slides, image grids, or when users ask for 杂志风 PPT, 瑞士风 PPT, Swiss Style, or a horizontal swipe deck.
...
| Path | `skills/creative/guizang-ppt-skill` |
| Version | `1.0.0` |
...
| Related skills | [`claude-design`](/docs/user-guide/skills/bundled/creative/creative-claude-design), [`p5js`](/docs/user-guide/skills/bundled/creative/creative-p5js), [`powerpoint`](/docs/user-guide/skills/bundled/productivity/productivity-powerpoint), [`popular-web-designs`](/docs/user-guide/skills/bundled/creative/creative-popular-web-designs) |
